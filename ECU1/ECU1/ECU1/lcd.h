...
#define LCD_RW_PORT			'C'							/**< port for RW line						*/
#define LCD_RW_PIN			 1							/**< pin number for RW line					*/ 
#define LCD_EN_PORT			'C'							/**< port for Enable line					*/
#define LCD_EN_PIN			 2							/**< pin number for EN line					*/ 

/*	Data Pins Configuration */
/*	configure from LCD_DATA0 to LCD_DATA7 if 8-bit mode 
*   configure from LCD_DATA4 to LCD_DATA7 if 4-bit mode and Ignore the first 4 pins
*/
#define LCD_DATA0_PORT		'C'							/**< port for Data bit 0 line				*/
#define LCD_DATA0_PIN		 4							/**< pin for Data bit 0 line				*/
#define LCD_DATA1_PORT		'C'							/**< port for Data bit 1 line				*/
#define LCD_DATA1_PIN		 6							/**< pin for Data bit 1 line				*/
#define LCD_DATA2_PORT		'C'							/**< port for Data bit 2 line				*/
#define LCD_DATA2_PIN		 0							/**< pin for Data bit 2 line				*/
#define LCD_DATA3_PORT		'C'							/**< port for Data bit 3 line				*/
#define LCD_DATA3_PIN		 1							/**< pin for Data bit 3 line				*/

#define LCD_DATA4_PORT		'C'							/**< port for Data bit 4 line				*/
#define LCD_DATA4_PIN		 4							/**< pin for Data bit 4 line				*/
#define LCD_DATA5_PORT		'C'							/**< port for Data bit 5 line				*/
#define LCD_DATA5_PIN		 5							/**< pin for Data bit 5 line				*/
#define LCD_DATA6_PORT		'C'							/**< port for Data bit 6 line				*/
#define LCD_DATA6_PIN		 6							/**< pin for Data bit 6 line				*/
#define LCD_DATA7_PORT		'C'							/**< port for Data bit 7 line				*/
#define LCD_DATA7_PIN		 7							/**< pin for Data bit 7 line				*/

/*	Definitions for Display Size
*	Change these definitions to adapt setting to your display
*/
#define LCD_LINES			2							/**< number of lines of the display lcd		*/
